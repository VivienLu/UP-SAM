...
if __name__ == '__main__':
    ...
    data_dir = '../../Datasets/BraTS19_data'
    ...
    print(len(trainset), train_sample['image'].shape, train_sample['label'].shape) # 250 torch.Size([1, 96, 96, 96]) torch.Size([96, 96, 96])
    print(len(valset), val_sample['image'].shape, val_sample['label'].shape) # 25 torch.Size([1, 96, 96, 96]) torch.Size([96, 96, 96])
    print(len(testset), test_sample['image'].shape, test_sample['label'].shape) # 60 torch.Size([1, 96, 96, 96]) torch.Size([96, 96, 96])
